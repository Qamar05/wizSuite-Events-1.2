...
class UpcomingEventAdapter(private val eventList: ArrayList<EventDetailsNew>, private val itemClickedListener: OnListItemClickedListener) :
    ...
    override fun onBindViewHolder(holder: UpcomingEventViewHolder, position: Int) {
        ...
        holder.binding.eventDate.text = DateFormatHelper.dateFormat(DateFormatHelper.yyyy_MM_dd,DateFormatHelper.EEE_MMM_dd_yyyy,eventList[position].events_start_date)
